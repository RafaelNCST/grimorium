...
interface CreateBeastModalProps {
  open: boolean;
...
export function CreateBeastModal({ open, onOpenChange, bookId }: CreateBeastModalProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.habit} onValueChange={(value) => setFormData({ ...formData, habit: value })}>
                <SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setFormData({ ...formData, humanComparison: value })}
              >
                <SelectTrigger>
