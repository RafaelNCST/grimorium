...
export interface IFactionAlignment {
  value: string;
  icon: LucideIcon;
 ...
 * Used in create-faction-modal for alignment selection (D&D style)
 */
export const FACTION_ALIGNMENTS_CONSTANT: IFactionAlignment[] = [
  {
    value: "lawful-good",
    icon: Shield,
