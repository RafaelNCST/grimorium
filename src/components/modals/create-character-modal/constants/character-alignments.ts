...
export const CHARACTER_ALIGNMENTS_CONSTANT: ICharacterAlignment[] = [
  {
    ...
    colorClass: "bg-green-500/20 border-green-500 text-green-700 dark:text-green-400",
  },
  {
    value: "neutral-good",
    icon: Heart,
  ...
  },
  {
    ...
    colorClass: "bg-gray-500/20 border-gray-500 text-gray-700 dark:text-gray-400",
  },
  {
    value: "true-neutral",
    icon: CircleDot,
