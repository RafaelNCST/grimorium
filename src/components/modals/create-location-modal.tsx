...
interface PropsCreateLocationModal {
  open: boolean;
  onClose: () => void;
...
export function CreateLocationModal({
  ...
  const handleAddOrganization = () => {
    if (
      ...
      !organizations.includes(newOrganization.trim())
    ) {
  ...
  const handleAddLivingEntity = () => {
    if (
      newLivingEntity.trim() &&
      !livingEntities.includes(newLivingEntity.trim())
    ) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData((prev) => ({ ...prev, climate: value }))
                }
              >
                <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                onKeyPress={(e) =>
                  e.key === "Enter" &&
                  (e.preventDefault(), handleAddOrganization())
                }
              />
              <Button
                type="button"
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                onKeyPress={(e) =>
                  e.key === "Enter" &&
                  (e.preventDefault(), handleAddLivingEntity())
                }
              />
              <Button
                type="button"
                variant="outline"
                onClick={handleAddLivingEntity}
              >
                <Plus className="w-4 h-4" />
              </Button>
            </div>
