  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          // Base styles (posicionamento, animação, estilo)
          "fixed left-[50%] top-[calc(50%+16px)] z-50 -translate-x-1/2 -translate-y-1/2",
          "grid gap-4 border bg-background p-6 shadow-lg sm:rounded-lg overflow-hidden",
          "duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          "data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%]",
          "data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]",
          // Tamanhos padrão (podem ser sobrescritos por className)
          "w-full max-w-lg",
          className
        )}
        onInteractOutside={(e) => {
