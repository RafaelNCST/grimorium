...
const mockOrganizations: Organization[] = [
  {
    ...
    alignment: "Bem",
    description:
      "Antiga ordem militar dedicada à proteção do reino e preservação da luz. Formada pelos melhores guerreiros e magos.",
    type: "Militar",
    influence: "Alta",
  ...
  },
  {
    ...
    alignment: "Caótico",
    description:
      "Organização secreta que busca trazer as trevas de volta ao mundo através de rituais sombrios e corrupção da magia.",
    type: "Culto",
    influence: "Média",
    ...
    titles: [
      {
        ...
        description: "Líder supremo do culto",
        level: 1,
      },
      {
        id: "t6",
        name: "Arcano Negro",
        description: "Mago especialista em trevas",
        level: 2,
      },
    ...
    members: [
      {
        characterId: "c4",
        characterName: "Malachar o Sombrio",
        titleId: "t5",
        joinDate: "Era das Trevas, 200",
      },
      {
        characterId: "c5",
        characterName: "Vex Nightbane",
        titleId: "t6",
        joinDate: "Era Atual, 1100",
      },
      {
        characterId: "c6",
        characterName: "Kael Darkthorn",
        titleId: "t7",
        joinDate: "Era Atual, 1110",
      },
    ],
  },
  {
    ...
    alignment: "Neutro",
    description:
      "Associação de ferreiros, encantadores e inventores. Neutros no conflito entre luz e trevas, focam no comércio e inovação tecnológica.",
    type: "Comercial",
    influence: "Média",
    ...
    titles: [
      {
        id: "t8",
        name: "Grão-Mestre",
        description: "Líder da guilda",
        level: 1,
      },
      {
        id: "t9",
        name: "Mestre Artífice",
        description: "Especialista experiente",
        level: 2,
      },
      {
        id: "t10",
        name: "Artífice",
        description: "Membro qualificado",
        level: 3,
      },
      {
        id: "t11",
    ...
    members: [
      {
        characterId: "c7",
        characterName: "Mestre Gorin Martelodouro",
        titleId: "t8",
        joinDate: "Era Atual, 1080",
      },
      {
        characterId: "c8",
        characterName: "Finn Pedraverde",
        titleId: "t9",
        joinDate: "Era Atual, 1105",
      },
      {
        characterId: "c9",
        characterName: "Elena Forjaruna",
        titleId: "t10",
        joinDate: "Era Atual, 1108",
      },
    ],
  },
];
