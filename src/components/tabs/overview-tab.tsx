...
export function OverviewTab({ book, bookId, isCustomizing }: PropsOverviewTab) {
  ...
  const progressPercentage = Math.round(
    (completedEvents / currentArcEvents.length) * 100
  );
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  onClick={() =>
                    setStoryProgress((s) => ({
                      ...s,
                      estimatedArcs: Math.max(1, s.estimatedArcs - 1),
                    }))
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    setStoryProgress((s) => ({
                      ...s,
                      estimatedArcs: s.estimatedArcs + 1,
                    }))
                  }
                >
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                size="sm"
                className="h-6 text-xs"
                onClick={() => setIsEditingAuthorSummary(false)}
              >
                Cancelar
              </Button>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                size="sm"
                className="h-6 text-xs"
                onClick={() => setIsEditingStorySummary(false)}
              >
                Cancelar
              </Button>
            </div>
