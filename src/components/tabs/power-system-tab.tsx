    ...
    (type: ElementType, x?: number, y?: number) => {
      ...
      if (x == null || y == null) {
        ...
        if (canvas) {
          ...
          console.log("[PowerSystem] computed center position", {
            rect,
            viewOffset,
            posX,
            posY,
          ...
          posX = 100;
          posY = 100;
          console.log("[PowerSystem] canvas not ready, using fallback", {
            posX,
            posY,
          });
        }
          ...
          <Tabs defaultValue="tips">
            ...
            <TabsContent value="tips" className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Use cores consistentes para categorizar elementos
                  relacionados. Agrupe conceitos similares próximos uns dos
                  outros.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Use sub-mapas para detalhar sistemas complexos. Mantenha o
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Use setas e linhas para mostrar relacionamentos, fluxos de
                  poder e dependências.
                </p>
              </div>
            </TabsContent>
            <TabsContent value="features" className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  No modo visualização, arraste para navegar pelo mapa. Use zoom
                  para ver detalhes.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  No modo edição, arraste elementos, use Delete para excluir, e
      ...
      <div className="flex-1 p-4 space-y-4 overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-5 gap-2">
              {["#ffffff", "#000000", "#374151", "#6B7280", "#9CA3AF"].map(
                (color) => (
                  <button
                    key={color}
        ...
        {(element.type === "visual-card" ||
          element.type === "details-card") && (
          <div className="space-y-2">
...
interface PropsTutorialOverlay {
  step: number;
  onNext: () => void;
  onPrev: () => void;
  onClose: () => void;
