...
const mockCharacters = [
  { id: "1", name: "Aelric Valorheart", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face" },
  { id: "2", name: "Elena Moonwhisper", image: "https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=300&h=300&fit=crop&crop=face" },
  { id: "3", name: "Marcus Ironforge", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face" },
  { id: "4", name: "Lyra Starweaver", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=face" },
  { id: "5", name: "Thane Stormborn", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=300&fit=crop&crop=face" },
  { id: "6", name: "Aria Nightsong", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=300&h=300&fit=crop&crop=face" },
  { id: "7", name: "Gareth Goldshield", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=300&h=300&fit=crop&crop=face" },
  { id: "8", name: "Vera Shadowbane", image: "https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?w=300&h=300&fit=crop&crop=face" },
  { id: "9", name: "Duncan Firebeard", image: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=300&h=300&fit=crop&crop=face" },
  { id: "10", name: "Seraphina Dawnbringer", image: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=300&h=300&fit=crop&crop=face" }
];
...
export function FamilyTreePage() {
    ...
    return (
      <div className="container mx-auto py-8 px-4 max-w-4xl">
        <div className="flex items-center gap-4 mb-8">
          <Button variant="ghost" onClick={() => navigate(`/book/${bookId}/character/${characterId}`)}>
            <ArrowLeft className="w-4 h-4 mr-2" />
            Voltar
          </Button>
          <h1 className="text-3xl font-bold">Árvore Genealógica - {character.name}</h1>
        </div>
  ...
  return (
    <div className={`container mx-auto py-8 px-4 ${isFullscreen ? 'max-w-full h-screen' : 'max-w-7xl'}`}>
      {/* Header */}
      ...
      <div className={`flex-1 overflow-auto p-6 bg-muted/20 rounded-lg ${isFullscreen ? 'h-[calc(100vh-200px)]' : 'min-h-[70vh]'}`}>
        <div 
