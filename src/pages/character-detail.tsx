                  ...
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/book/1/character/${character.id}/family-tree`
                          )
                        }
                      >
                        ...
                        <div className="grid grid-cols-1 gap-3">
                          <div className="space-y-2">
                            ...
                            <Select
                              ...
                              onValueChange={setSelectedRelationshipCharacter}
                            >
                              <SelectTrigger>
                            ...
                            <div className="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto p-2 border rounded-lg bg-background">
                              {relationshipTypes.map((type) => (
                                <div
                                  ...
                                  onClick={() =>
                                    setSelectedRelationshipType(type.value)
                                  }
                                >
                                  <div className="text-center space-y-1">
                                ...
                                >
                                  ...
                                  <div className="space-y-1">
                                    ...
                                    <Slider
                                      ...
                                      onValueChange={(value) =>
                                        handleUpdateRelationshipIntensity(
                                          relationship.id,
                                          value[0]
                                        )
                                      }
