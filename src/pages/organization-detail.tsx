...
export function OrganizationDetail() {
  ...
  const availableWorlds = [{ id: "w1", name: "Aethermoor", type: "Mundo" }];
              ...
              <div>
                ...
                {isEditing ? (
                  <Select
                    ...
                    onValueChange={(value) =>
                      setEditData((prev) => ({ ...prev, alignment: value }))
                    }
                  >
                    <SelectTrigger className="mt-1">
              ...
              <div>
                ...
                {isEditing ? (
                  <Select
                    ...
                    onValueChange={(value) =>
                      setEditData((prev) => ({ ...prev, influence: value }))
                    }
                  >
                    <SelectTrigger className="mt-1">
                        ...
                        return (
                          ...
                          >
                            ...
                            <Button
                              ...
                              className="h-6 w-6"
                              onClick={() =>
                                handleRemoveDominatedLocation(location)
                              }
                            >
                              <X className="w-3 h-3" />
                            </Button>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewMember((prev) => ({ ...prev, characterId: value }))
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewMember((prev) => ({ ...prev, titleId: value }))
                }
              >
                <SelectTrigger>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                value={newTitle.name}
                onChange={(e) =>
                  setNewTitle((prev) => ({ ...prev, name: e.target.value }))
                }
              />
            </div>
