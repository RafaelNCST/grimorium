...
export function CreateRaceVersionDialog({
  open,
  onClose,
  onConfirm,
  baseRace,
}: CreateRaceVersionDialogProps) {
  ...
  const handleRaceCreate = useCallback(
  ...
  return (
    <>
      ...
      {/* Step 2: Race Creation Modal */}
      {step === 2 && (
        <CreateRaceModal
          open={isRaceModalOpen}
          onClose={handleRaceModalClose}
          onConfirm={handleRaceCreate}
          availableRaces={[]}
        />
      )}
    </>
