...
export const ItemDetailView = React.memo(
  ({
        ...
        {isEditing ? (
          ...
          <>
            ...
            <div className="space-y-3 mt-4">
              {/* Name */}
              <h2 className="text-3xl font-bold select-text">{item.name}</h2>
    ...
    const detailedDescriptionsFields = [
      "appearance",
      "origin",
      "alternativeNames",
    ];
    ...
    const hideDetailedDescriptionsSection = areAllFieldsHidden(
      detailedDescriptionsFields
    );
              ...
              {isEditing ? (
                <>
                  <Textarea
                    ...
                    maxLength={1000}
                    placeholder={t(
                      "item-detail:placeholders.narrative_purpose"
                    )}
                  />
                  <div className="flex justify-end text-xs text-muted-foreground">
              ...
              {isEditing ? (
                <>
                  <Textarea
                    ...
                    maxLength={1000}
                    placeholder={t(
                      "item-detail:placeholders.usage_requirements"
                    )}
                  />
                  <div className="flex justify-end text-xs text-muted-foreground">
              ...
              {isEditing ? (
                <>
                  <Textarea
                    ...
                    maxLength={1000}
                    placeholder={t(
                      "item-detail:placeholders.usage_consequences"
                    )}
                  />
                  <div className="flex justify-end text-xs text-muted-foreground">
