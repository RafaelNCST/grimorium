...
/**
 * Optimized family field component that doesn't reload data on every render
 */
export const FamilyFieldOptimized = React.memo(function FamilyFieldOptimized({
  label,
  placeholder,
  emptyText,
  noSelectionText,
  ...
  const options = useMemo(
    ...
    [allCharacters, currentCharacterId]
  );
