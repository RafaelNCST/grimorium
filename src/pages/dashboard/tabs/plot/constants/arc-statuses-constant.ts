...
export const ARC_STATUSES_CONSTANT: IArcStatusConstant[] = [
  {
    ...
    hoverColor: "hover:bg-emerald-500/10 hover:text-emerald-600 hover:border-emerald-500/20",
    activeColor:
  ...
  },
  {
    ...
    activeColor: "bg-blue-500/20 text-blue-600 border-blue-500/30 ring-2 ring-blue-500/50",
  ...
  },
  {
    ...
    icon: Clock,
    color: "bg-card text-muted-foreground border-border",
    hoverColor: "hover:bg-amber-500/10 hover:text-amber-600 hover:border-amber-500/20",
    activeColor: "bg-amber-500/20 text-amber-600 border-amber-500/30 ring-2 ring-amber-500/50",
